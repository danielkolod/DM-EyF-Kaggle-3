...
FErf_attributes_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$training <- c( 202106, 202009, 201909)
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(
    ...
    202009,202008,202007,202005,202002,
    # 201910 Excluyo por variables rotas
    201909,201908,201907, 201906, 201904,201903,201902
...
wf_SEMI_ago_orden227_6_6_6_sinmesesrotos_tend1_tend2_RFmodificado_05undersampling <- function( pnombrewf )
{
...
wf_SEMI_ago_orden227_6_6_6_sinmesesrotos_tend1_tend2_RFmodificado_05undersampling()
